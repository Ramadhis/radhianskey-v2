    ...
    return (
        <>
            <button
                ...
                className={` ${
                    saveType == "save-as"
                        ? `bg-[#2c508a] hover:bg-[#213e6d] border-white hover:text-white`
                        : `border-[#2c508a] hover:bg-[#2c508a]`
                }  border  hover:border-zinc-300 ms-2 py-1 rounded-sm px-4 text-sm text-white font-medium inline ${
