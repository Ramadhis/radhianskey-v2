    ...
    return (
        <>
            <Draggable draggableId={id} key={id} index={index}>
                {(provided) => {
                    return (
                        <div className="border border-transparent hover:border-white rounded-md">
                            <div
                                ref={provided.innerRef}
                                {...provided.draggableProps}
                                {...provided.dragHandleProps}
                                className="w-[58px] h-[58px] m-[3px] bg-stone-400 border border-r-stone-500 border-b-stone-500 border-l-stone-200 border-t-stone-200 text-black rounded-sm flex justify-center relative"
